...
exports.searchLectures = exports.getLectureById = exports.getLectures = void 0;
...
const searchLectures = async (req, res) => {
    ...
    const { q } = req.query;
    if (!q) {
        throw new Errors_1.NotFound("Please enter a search term");
    }
...
exports.searchLectures = searchLectures;
